 ...
 */
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        if (updateUserData) {
          updateUserData.addEventListener('submit', function (e) {
            ...
            form.append(
              'photo',
              document.querySelector('.form__upload').files[0],
            );
        ...
        if (updateUserPassword) {
          updateUserPassword.addEventListener(
            'submit',
            /*#__PURE__*/ (function () {
              var _ref = _asyncToGenerator(
      ...
      },
      {
        ...
        './login': 'login.js',
        './mapBox': 'mapBox.js',
        './updateSetting': 'updateSetting.js',
        './paypal': 'paypal.js',
      },
    ],
