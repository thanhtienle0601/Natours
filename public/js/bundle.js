...
var showAlerts = exports.showAlerts = function showAlerts(type, msg) {
  hiddenAlert();
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlerts)('success', 'Logged in successfully !');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlerts)('error', 'Error logging out ! Please try again !');
        case 11:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbmh0aWVubGUwNjAxIiwiYSI6ImNtMGVvdGw3dDBwN2UybHMxamw0c2c0ODEifQ.8TyhC2MPUa76rCHXMOTA6g';
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alerts.showAlerts)('success', "".concat(type.toUpperCase(), " Data update successfully !"));
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Pxg9HKz66CdPDlPCbOcS6Zb6L9D2QQxJglwS1lnYBzvDgjzRxDjWtznxT6jmHQyuodwiQTqgdhKAvaau8xHmKLG00qfvZz4Mk');
...
if (updateUserPassword) {
  updateUserPassword.addEventListener('submit', /*#__PURE__*/function () {
